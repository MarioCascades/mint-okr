...
const description = { fontSize: 14, color: '#9CA3AF', marginBottom: 20 }
...
const editButton = { backgroundColor: '#00AEEF', border: 'none', padding: '6px 12px', borderRadius: 6, color: '#000', fontWeight: 600 }
const backButton = { backgroundColor: '#1F2937', border: 'none', padding: '6px 12px', borderRadius: 6, color: '#fff' }
const monthText = { fontSize: 14, fontWeight: 600 }
const objective = { marginBottom: 40 }
const objectiveTitle = { color: '#00AEEF' }
const headerRow = { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 1fr', gap: 8 }
const row = { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 1fr', gap: 8 }
const cell = { background: '#0A0A0A', border: '1px solid #1F2937', borderRadius: 6, color: '#fff' }
const button = { backgroundColor: '#00AEEF', border: 'none', borderRadius: 6, padding: '4px 8px', color: '#000' }